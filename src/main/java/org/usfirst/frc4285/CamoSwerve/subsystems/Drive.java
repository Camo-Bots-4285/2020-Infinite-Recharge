...
public class Drive extends Subsystem {
    ...
    private static final double STEER_P = 3.85;
    private static final double STEER_I = 0.00;
    private static final double STEER_D = 35;
    ...
    public void swerveDrive(double strafe, double forward, double omega) {
        ...
        int robot_config = 1;
        if (robot_config == 1) {
            // 2020 Main Robot Configuration
            angleLF = angle(B, D) - 110;
            angleLR = angle(A, D) - 80.5;
            angleRF = angle(B, C) + 97.5;
            angleRR = angle(A, C) + 22;
        }
